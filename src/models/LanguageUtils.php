...
class LanguageUtils extends BaseObject
{
    static public function getLanguageFromId(string $language_id): array
    {
        /**
        ...
        $result = ['language_id' => 'hu-HU', 'language' => 'hu', 'country' => 'hu', 'name' => 'Magyar', 'name_ascii' => 'Hungarian', 'status' => 1];
        foreach ($languages as $_language) {
            if ($_language[0] === $language_id) {
                $result = ['language_id' => $_language[0], 'language' => $_language[1], 'country' => $_language[2], 'name' => $_language[3], 'name_ascii' => $_language[4], 'status' => 1];
                break;
            }
        }
        return $result;
